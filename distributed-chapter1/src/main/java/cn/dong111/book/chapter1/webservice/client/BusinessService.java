...
package cn.dong111.book.chapter1.webservice.client;
    ...
    extends Service
{
    ...
    private final static QName BUSINESSSERVICE_QNAME = new QName("http://webservice.chapter1.book/client", "BusinessService");
    ...
    public Business getBusinessPort() {
        return super.getPort(new QName("http://webservice.chapter1.book/client", "BusinessPort"), Business.class);
    }
    ...
    public Business getBusinessPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.chapter1.book/client", "BusinessPort"), Business.class, features);
    }
